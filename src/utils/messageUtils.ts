...
export const getChatGPTEncoding = (
  ...
  const isGpt3 = model === 'gpt-3.5-turbo' || model === 'majo:gpt-3.5-turbo' || model === 'openai:gpt-3.5-turbo'
                || model === 'openai:gpt-3.5-turbo-16k' || model === 'openai:gpt-3.5-enhanced-for-role-play';
